    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "Self-attention-integrated LiDAR-based 3D object detection network in a crowded hospital environment",
          section: "Projects",handler: () => {
              window.location.href = "/projects/saldnet/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%67%6F%65%75%6E%36%37%38@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=dFrDfNsAAAAJ&hl=ko", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/goeun-kim-aa6217342/", "_blank");
        },
      },{
      id: 'light-theme',
