...
<p align="center">
  <img src="/images/papers/rigid_transformation.png" width="500">
  <br><em>**Rigid transformation:** 형태와 크기를 유지하면서 위치나 방향만 바뀌는 변환. </em>
</p>

<p align="center">
  <img src="/images/papers/affine_transformation.png" width="500">
  <br><em>**Affine transformation:** 직선, 평행성, 거리 비율을 보존하는 변환. </em>
</p>


### Differences from Image Data
| | Image Data | Point Cloud Data |
|---|---|---|
...
| **Feature-based DNN** | Pre-extracted shape features | Limited representation power |
